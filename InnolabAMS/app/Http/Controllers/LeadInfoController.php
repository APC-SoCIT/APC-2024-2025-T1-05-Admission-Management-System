...
class LeadInfoController extends Controller
{
    ...
    {
        return view('lead_info.create'); // Show the create form
    }
    ...
    public function store(Request $request)
    {
        ...
        // Redirect to the inquiry list or wherever appropriate
        return redirect()->route('lead_info.index')->with('success', 'Inquiry created successfully!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('lead_info.index')->with('success', 'Inquiry updated successfully!');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('lead_info.index')->with('success', 'Inquiry deleted successfully!');
    }
}
