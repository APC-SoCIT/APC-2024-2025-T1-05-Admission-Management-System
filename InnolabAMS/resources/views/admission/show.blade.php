...
<div id="rejectModal" class="fixed inset-0 bg-gray-500/50 backdrop-blur-sm hidden items-center justify-center z-50">
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <div class="p-6">
            <h2 class="text-xl font-semibold mb-4">Confirm Application Rejection</h2>
            <p class="text-gray-600 mb-6">Are you sure you want to reject this application? This action cannot be undone.</p>
            <div class="flex justify-end space-x-3">
                <button onclick="closeRejectModal()"
                    class="px-3 py-1 bg-gray-100 hover:bg-gray-200 text-gray-800 rounded-md transition-colors">
                    Cancel
                </button>
...
function submitReject() {
    if (rejectForm) {
        // Create a hidden input for the reject status if it doesn't exist
