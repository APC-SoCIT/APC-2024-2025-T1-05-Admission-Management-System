    ...
    <div class="border-b border-gray-200 mb-6">
        <nav class="-mb-px flex space-x-8">
            <a href="{{ route('admission.index') }}"
               class="{{ request()->routeIs('admission.index') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                All Applications
            </a>
            <a href="{{ route('admission.new') }}"
               class="{{ request()->routeIs('admission.new') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                New ({{ $newCount ?? 0 }})
            </a>
            <a href="{{ route('admission.accepted') }}"
               class="{{ request()->routeIs('admission.accepted') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
                Accepted ({{ $acceptedCount ?? 0 }})
            </a>
            <a href="{{ route('admission.rejected') }}"
               class="{{ request()->routeIs('admission.rejected') ? 'border-blue-500 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap py-4 px-1 border-b-2 font-medium text-sm">
