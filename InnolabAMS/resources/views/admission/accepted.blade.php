...
@extends('dashboard')
@section('title', 'Accepted Applications | InnolabAMS')
>>>>>>> 0034be4 (refactor: enhance accepted applications view with improved navigation and UI design)
=======
@section('title', 'Accepted Applications | InnolabAMS')
@extends('application')
...
@push('scripts')
<!-- Same JavaScript as in index.blade.php and new.blade.php -->
<script>
    // Previous JavaScript code (same as in new.blade.php)
</script>
@endpush
@endsection