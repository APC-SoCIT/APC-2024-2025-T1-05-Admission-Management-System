...
<div class="container">
    ...
    <form action="{{ route('lead_info.store') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <select name="skills_lead" id="skills_lead" required>
        ...
        <div class="form-group" id="other_skills_container" style="display: none;">
            <label for="other_skills_lead">Please specify your other skills <span class="required">*</span></label>
            <input type="text" name="other_skills_lead" id="other_skills_lead" class="form-control" placeholder="Enter your skills">
        </div>
