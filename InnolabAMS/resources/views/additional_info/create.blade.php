...
<!-- Previous button -->
<div class="mb-4">
    <a href="{{ route('form.personal_info') }}" class="bg-gray-500 text-white px-6 py-2 rounded hover:bg-gray-600">
        Previous
    </a>
</div>

<div class="bg-white rounded-lg shadow-lg p-6">
    <form id="additionalInfoForm" action="{{ route('additional_info.store') }}" method="POST">
        @csrf
        ...
        <div class="mb-6">
            ...
            <div class="mb-4">
                <label for="extracurricular_interest" class="block text-sm font-medium text-gray-700">Extracurricular
                    Interests</label>
